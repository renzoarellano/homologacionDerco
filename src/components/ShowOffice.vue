            ...
            <b-col cols="12">
              ...
              <b-row>
                <b-col cols="12" class="breadcrumb">
                  <b-link :to="{ name: 'BrandListOffices' }">Clientes por Oficinas</b-link> &raquo; <b-link :href="'/clients-by-offices/brand/'+ office.slug">Lista de Oficinas de {{ office.brand }}</b-link> &raquo; {{office.name}}:
                </b-col>
              </b-row>
              <div class="mt-2"></div>

            ...
            <b-col cols="12">
              ...
              <b-row>
                <b-col cols="12" class="breadcrumb">
                  &raquo; Lista de mensajes de contactos para {{ this.brand }}:
                </b-col>
              </b-row>
              <div class="mt-2"></div>
  ...
  data() {
    return {
      fields: {
        ...
        subject: { label: "Asunto", sortable: true, class: "text-left" },
  ...
  methods: {
    details (contact) {
      ...
      this.$router.push({
        ...
        params: { id: contact.id, slug: this.$route.params.slug }
      })
    },
    descargar_csv(){

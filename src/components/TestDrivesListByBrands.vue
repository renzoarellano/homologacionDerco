            ...
            <b-col cols="12">
              <b-row>
                <b-col cols="12" class="head">
                  <h4>:: Test Drive</h4>
                  <b-btn @click.stop="descargar_csv">Descargar Lista de participantes</b-btn>
                </b-col>
              </b-row>
              <b-row>
                <b-col cols="12" class="breadcrumb">
                  <b-link href="/testdrives">Test Drive</b-link> &raquo; Lista de participantes para {{ this.$route.params.brand }}:
                </b-col>
              </b-row>
              <div class="mt-2"></div>
...
var headers = {
  ...
  brand: 'Marca'.replace(/,/g, ''),
  dni: 'DNI',
  email: 'Correo electrónico',
  model_car: 'Modelo del auto',
  phone: 'Celular',
  store: 'Tienda',
...
export default {
  ...
  data() {
    return {
      fields: {
        ...
        phone: { label: "Celular", sortable: false, class: "text-center" },
  ...
  created() {
    axios
      .get(`/testdrive/` + this.$route.params.brand)
      .then(response => {
